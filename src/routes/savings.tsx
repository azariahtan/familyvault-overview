...
// Display order: FD → Banks → SRS → CPF (then anything else)
...
function SavingsPage() {
  ...
  const groups = Array.from(new Set(items.map((i: any) => i.group_name))).sort(
                  ...
                  rightMeta={
                    <div className="text-right text-xs">
                      ...
                      <div className="mt-0.5 flex items-center justify-end gap-1 text-[10px] text-muted-foreground">
                        ...
                        <span>
                          {a.last_updated ? `Last updated: ${fmtDate(a.last_updated)}` : "Never updated"}
                        </span>
                      </div>
